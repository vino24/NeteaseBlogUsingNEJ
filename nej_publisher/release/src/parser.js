...
var __doPrepareCore = (function(){
    ...
    return function(_result){
        ...
        for(var i=0,l=_list.length,_file,_cont;i<l;i++){
...
var __doInlineFile = (function(){
    ...
    return function(_content,_conf){
        return util.format(
              ...
              _content.replace(_reg0,'<&#47;script>')
                      .replace(_reg1,'<&#47;textarea>'));
    };
})();
/*
 * 合并样式和脚本
...
var __doMergeCSandJS = (function(){
    ...
    return function(_result){
        var _data  = _result.output,
            ...
            _fobj,_content,_value,_flag,_clink;
        for(var x in _files){
            _fobj = _files[x];
...
var __doMergeTemplate = (function(){
    var _reg0 = /#<TP_HTML>/gi,
        _reg1 = /#<(js|cs|[\d]*?):(.*?)>/gi,
        _reg2 = /<meta.*?>/i;
    var _doMerge = function(_file,_data,_test){
        ...
        if (!util.isArray(_list)){
            ...
            for(var i=0,l=_list.length,_name,_result;i<l;i++){
                ...
                if (!!_test[_name]) 
                    continue;
                _test[_name] = !0;
                _result = _doMerge(_name,_data,_test);
...
var __doOutputFile = (function(){
    ...
    return function(_name,_result){
        var _data = _result.output[_name],
