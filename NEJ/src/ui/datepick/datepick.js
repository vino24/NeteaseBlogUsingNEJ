...
var f = function(){
    ...
    _seed_date = _e._$addHtmlTemplate('\
        <div class="zday">\
        <div class="zth"><table><tr>{list ["日","一","二","三","四","五","六"] as x}<th>${x}</th>{/list}</tr></table></div>\
		<div class="zbody"><table>\
          {list 1..6 as x}\
    ...
    _e._$addTextTemplate(_seed_action,'\
        <div class="zact">\
          <span class="zbtn zfl zbtn-ln" title="上一年">&lt;&lt;</span>\
          <span class="zbtn zfl zbtn-ly" title="上一月">&lt;</span>\
          <span class="zbtn zfr zbtn-rn" title="下一年">&gt;&gt;</span>\
          <span class="zbtn zfr zbtn-ry" title="下一月">&gt;</span>\
